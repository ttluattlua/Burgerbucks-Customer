...
public class Dao_Burger {

  private static Dao_Burger dao_burger = new Dao_Burger();
  public Dao_Burger() {  DBConnection.initConnect(); }
  public static Dao_Burger getInstance() { return dao_burger;  }

  //햄버거 등록
  public boolean addBurger(Bb_BurgerDto burger) {
